...
export const BASE_URL='http://121.5.128.97:9009/v1.0'
export const PROJECT_NOTICE='/sponsor-microservice/projects/projectAndNotice?id='
export const SPONSORED_URL='http://121.5.128.97:9010/v2.0/sponsored-microservice'
/* ----------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------ */
/*-----------------------------  反馈相关  ----------------------------*/
export const UPLOAD_PICTURE_URL='upload'
